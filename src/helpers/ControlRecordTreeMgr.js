...
export default class ControlRecordTreeMgr {
  ...
  getBrotherTrees(parentTree, targetFormFieldPath) {
    ...
    if (getPrefix(parentTree.formFieldPath) === getPrefix(targetFormFieldPath) && !parentTree.voided) {
  ...
  static add(rootTree, formFieldPath) {
    ...
    return treeMgr.addToRootTree(rootTree, parentTree, addedTree.voidChildRecordUuids());
  }
